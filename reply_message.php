...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE contact_form SET reply = ?, reply_timestamp = NOW() WHERE contact_id = ?";
    if ($stmt = $conn->prepare($sql)) {
...
<body class="starter-page-page">
  ...
  <main class="main">
    ...
    <div class="page-title accent-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Admin Panel</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.html">Home</a></li>
            <li class="current">Admin Panel</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
  ...
  <p><strong>Message:</strong> <?php echo nl2br($message['message']); ?></p>

  <form method="POST">
    <label for="reply">Your Reply:</label><br>
    <textarea name="reply" id="reply" rows="4" cols="50"></textarea><br><br>
